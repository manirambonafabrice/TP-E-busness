...
this.info_validateur=res.info_validateur
    ...
    this.info_service.getHistoriqueConge(this.activatedRoute.snapshot.url[1].path,res.demandeur[0].ID).subscribe
    (res=>{
  ...
  // console.log(this.activatedRoute.snapshot.url[1].path)
  this.info_service.getOne(res.demandeur[0].ID).subscribe
  (res=>{
  ...
  this.info_service.getSoldeConge(res.demandeur[0].ID).subscribe
  (res=>{
