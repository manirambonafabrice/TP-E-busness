...
class Taxes_Nonenvoye extends StatefulWidget {

  int id=0;

  @override
  _Taxes_NonenvoyeState createState() => _Taxes_NonenvoyeState();
}

class _Taxes_NonenvoyeState extends State<Taxes_Nonenvoye> {
                                ...
                                Padding(
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      userdata.write('numero_fact',"${taxes[position]['NUMERO_FACTURE']}");
