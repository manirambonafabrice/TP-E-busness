...
@Component({
  selector: 'app-point-focal',
  templateUrl: './point-focal.component.html',
  styleUrls: ['./point-focal.component.scss']
})
  ...
  this.provinces_filtre=res.provinces
    ...
    if(JSON.parse(sessionStorage.getItem("usersession")).data.ID_RAISON>0){
      this.dtOptions_province = {
        ...
        ajax: {
                  url:this.connexion.base_url+"routes.transport/list_point_vente",
                  type:"GET", 
                    headers: {
